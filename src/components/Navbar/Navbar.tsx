                    ...
                    <FlexBetween gap="2rem">
                        ...
                        <FormControl variant="standard" value={fullName}>
                            ...
                            >
                                ...
                                <MenuItem onClick={() => dispach(setLogout())}>Logout</MenuItem>
                            </Select>
                        </FormControl>
                    </FlexBetween>
                ) : (
                    <IconButton onClick={() => setIsModebileMenuToggled(!isMobileMenuToggled)}>
                        <Menu />
                    </IconButton>
                )
            }
            {!isMobileMenuToggled && isMobileMenuToggled && (
                ...
                >
                    <Box display="flex" justifyContent="flex-end" p="1rem">
                        <IconButton
                            onClick={() => setIsModebileMenuToggled(!isMobileMenuToggled)}
                        >
                            <Close />
                        </IconButton>
                    </Box>
